...
void Tutorial02_Cube::CreateVertexBuffer()
{
    ...
    constexpr Vertex CubeVerts[4] =
        {
            {float3{-0.57, 0, -0.5}, float4{1, 0, 0, 1}}, // V0
            {float3{0.57, 0, -0.5}, float4{0, 1, 0, 1}},  // V1
            {float3{0, 0, 1}, float4{0, 0, 1, 1}},   // V2

            // Vértice superior
            {float3{0, 1, 0}, float4{1, 1, 1, 1}}, // V3 (Pico)
        };
